...
import java.applet.*;
import java.awt.*;
/* <applet code="javaawt" width="500" height="500"></applet>*/
public class javaawt extends Applet
{
	public void init()
	{
	    	setLayout(null);
	...
	public void paint(Graphics g)
	{
		...
		g.drawString("--manasi bharati",350,255);
		g.setColor(Color.BLACK);
		g.drawRect(170,40,250,30 );
		g.drawRect(170,90,250,30);
	}
}